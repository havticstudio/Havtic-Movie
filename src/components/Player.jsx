    ...
    >
      ...
      <div className={`absolute bottom-4 right-4 z-20 transition-opacity duration-500 ${showControls ? 'opacity-100' : 'opacity-0'}`}>
        <button 
          ...
          className="w-10 h-10 rounded-xl bg-black/50 hover:bg-brand/90 backdrop-blur-md flex items-center justify-center text-white transition-all cursor-pointer border border-white/10 shadow-lg"
